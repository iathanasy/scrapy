...
class Qb5RqSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # 玄幻奇幻
        # novel_topic = "玄幻奇幻"
        # link = "https://www.qb5.tw/fenlei/1_1/"
        # novel_topic_id = 1
        ...
        # 都市言情
        # novel_topic = "都市言情"
        # link = "https://www.qb5.tw/fenlei/3_1/"
        # novel_topic_id = 3

        # 历史军事
        # novel_topic = "历史军事"
        # link = "https://www.qb5.tw/fenlei/4_1/"
        # novel_topic_id = 4

        # 网游竞技
        # novel_topic = "网游竞技"
        # link = "https://www.qb5.tw/fenlei/5_1/"
        # novel_topic_id = 6

        # 科幻灵异
        # novel_topic = "科幻灵异"
        # link = "https://www.qb5.tw/fenlei/6_1/"
        # novel_topic_id = 7

        # 恐怖灵异
        # novel_topic = "恐怖灵异"
        # link = "https://www.qb5.tw/fenlei/7_1/"
        # novel_topic_id = 8

        # 其他类型
        novel_topic = "其他类型"
        link = "https://www.qb5.tw/fenlei/8_1/"
        novel_topic_id = 9
    ...
    def parse_two(self, response):
        ...
        novle_lists = response.xpath('//*[@id="main"]/div[3]/div/ul/li')
        for i in novle_lists:
            novel_name = i.xpath('./span[@class="sp_name"]/a/@title').get()
            link = i.xpath('./span[@class="sp_name"]/a/@href').get()
